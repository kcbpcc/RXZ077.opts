...
filtered_data = print_df.query('qty > 0')[['MN', 'strike', 'CP', 'qty','tgtoptsmadepth', 'PL%', 'PnL','booked']]
...
if filtered_data.empty:
    ...
    print(filtered_data.to_string(header=False, index=False, col_space=[2, 10, 2, 3, 4, 4, 7, 7]))
